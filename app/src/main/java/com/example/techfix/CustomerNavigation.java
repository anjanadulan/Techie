...
public final class CustomerNavigation {
    ...
    public static void bind(AppCompatActivity activity, int selected) {
        ...
        int[] icons = {R.id.navHomeIcon, R.id.navServicesIcon, R.id.navBookingsIcon, R.id.navProfileIcon};
        int[] labels = {R.id.navHomeLabel, R.id.navServicesLabel, R.id.navBookingsLabel, R.id.navProfileLabel};
        Class<?>[] screens = {CustomerHomeActivity.class, ServicesActivity.class, RepairHistoryActivity.class, AccountActivity.class};
        ...
        for (int index = 0; index < containers.length; index++) {
            ...
            item.setBackgroundResource(isSelected ? R.drawable.bg_customer_nav_selected : android.R.color.transparent);
